...
%%--biblatex--%%\usepackage{csquotes}
%%--biblatex--%%\RequirePackage[
%%--biblatex--%%    backend=biber,
%%--biblatex--%%    style=numeric,
%%--biblatex--%%    sorting=none,     % Sortowanie wg kolejności występowania
%%--biblatex--%%    urldate=iso,      % Daty URL w formacie ISO
%%--biblatex--%%    seconds=true      % Pokaż sekundy w datach dostępu (opcjonalnie)
%%--biblatex--%%]{biblatex}
%%--biblatex--%%\addbibresource{references.bib}
...
% Alternatą do tgterms są czcionki newtxttext.
% Współgrają z odpowiednikami newtxtmath (w otoczeniu matematycznym).
% Aby je użyć należy zakomentować deklaracje powyższe (dla tgtermes) 
% oraz odkomentować deklaracje poniższe
%\input{glyphtounicode}
%\pdfgentounicode=1
%\usepackage{newtxtext} 
%\usepackage{newtxmath}

\usepackage{microtype} % pakiet odpowiedzialny za poprawę wyglądu tekstu
...
\setlength{\textwidth}{\paperwidth-5cm} %\setlength{\textwidth}{\paperwidth-5.5cm} - jeśli dodać binding 5mm 
\setlength{\spinemargin}{2.5cm} %\setlength{\spinemargin}{3.0cm} - jeśli dodać binding 5mm
...
% INFO: Pomocnicze makro do wyróżniania tekstu w języku angielskim
\newcommand{\eng}[1]{(ang.~\emph{#1})}
% Niewidoczny punkt zaczepienia dla pustych sekcji (poprawia łamanie stron w szkielecie)
\newcommand{\sectionanchor}{\strut\par}
